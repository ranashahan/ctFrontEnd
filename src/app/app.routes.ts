  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [authGuard],
        data: { roles: ['admin', 'director', 'manager', 'staff', 'member'] },
      },
      {
        path: 'alldrivers/:id',
      ...
      },
      {
        ...
        canActivate: [authGuard],
        data: { roles: ['admin', 'director', 'manager', 'staff'] },
      },
      {
        path: 'allassessments',
      ...
      },
      {
        ...
        canActivate: [authGuard],
        data: { roles: ['admin', 'director', 'manager'] },
      },
      {
        path: 'alltrainings',
        component: AlltrainingsComponent,
        canActivate: [authGuard],
        data: { roles: ['admin', 'director', 'biller', 'manager'] },
      },
      {
